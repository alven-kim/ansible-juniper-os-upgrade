...
<span style="color:pink">+ 꼭! 현재 OS에서 테스트 완료 후에 앤서블로 해보자</span>  
...
YAML Config
-----------
 - Normal OS Upgrade : juniper-os.yml  
 - [N/I]SSU OS Upgrade : juniper-os-su.yml
...
<span style="color:green">3. virtual-chassis를 pre-provisioning으로 구성하여야만 NSSU가 사용될 수 있음. ( 가장 중요 )</span>  
...
<span style="color:blue">10. 즉, NSSU가 정상적으로 마치게 되면, 기존에 backup이었던 1번 장비가 Master로 변환된 상태</span>
...
See Also
--------
 - https://galaxy.ansible.com/juniper/device  
