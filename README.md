...
3. <span style="color:green">virtual-chassis를 pre-provisioning으로 구성하여야만 NSSU가 사용될 수 있음. ( 가장 중요 )</span>  
...
10. <span style="color:blue">즉, NSSU가 정상적으로 마치게 되면, 기존에 backup이었던 1번 장비가 Master로 변환된 상태</span>
